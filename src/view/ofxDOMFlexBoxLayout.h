...
protected:
	...
	FlexDirection getFlexDirection(DOM::Element* e, FlexDirection defaultVal = FlexDirection::ROW);
	...
	float getWidthAndMargin(DOM::Element* e);
	float getHeightAndMargin(DOM::Element* e);
	float getDesiredWidth(DOM::Element* e);
	float getDesiredHeight(DOM::Element* e);

	void setWidthInLayout(DOM::Element* e, float width);
	void setHeightInLayout(DOM::Element* e, float height);
